      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center text-center">
          ...
          >
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">{aboutText}</p>
          ...
          >
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex items-start space-x-4 p-6 bg-gray-700 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300"
              >
